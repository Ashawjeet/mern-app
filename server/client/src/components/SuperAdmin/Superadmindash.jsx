...
//         };
//         const response = await axios.put(
//           `https://mern-app-20ia.onrender.com/api/disableOrganization/enable/${adminId}`,
//           {},
//           config
//         );
//         if (response.status === 200) {
...
//       };
//       const response = await axios.get(
//         `${API_BASE_URL}/api/superadmins/me`,
//         config
//       );
//       setSuperAdminDetails(response.data);
//     } catch (error) {
...
//         };
//         const response = await axios.put(
//           `${API_BASE_URL}/api/disableOrganization/${adminId}`,
//           {},
//           config
//         );
//         if (response.status === 200) {
...
//         };
//         const response = await axios.put(
//           `${API_BASE_URL}/api/disableOrganization/enable/${adminId}`,
//           {},
//           config
//         );
//         if (response.status === 200) {
...
const Superadmindash = () => {
  ...
  // Set the API base URL using environment variable or fallback to localhost for development
  const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'http://localhost:5000';
