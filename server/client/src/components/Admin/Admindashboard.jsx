...
//         // Fetch all program managers for Super Admin
//         response = await axios.get(
//           `http://localhost:5000/api/programmanagers/superadmin/${
...
//         },
//       };
//       // Determine which endpoint to hit based on the current user role and view type
//       let endpoint = "/api/admins/me/programmanagers";
//       if (adminDetails.role === "Super Admin") {
//         endpoint += showActive ? "/active" : "/inactive";
//       } else {
//         endpoint += showActive ? "/active/by-admin" : "/inactive/by-admin";
//       }
...
const Admindash = () => {
  ...
  const fetchProgramManagers = async () => {
    try {
      ...
      let url = "http://localhost:5000/api/admins/me/programmanagers";
      if (allProgramManagers) {
        url = showActive
          ? "http://localhost:5000/api/programmanagers/active"
          : "http://localhost:5000/api/programmanagers/inactive";
      }
